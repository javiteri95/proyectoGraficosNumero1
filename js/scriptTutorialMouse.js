...
Esto es un copy paste de un tutorial en internet que encontre para un picking , cambie una linea la del plane.visible 
para que coincida con la version de three js 
